...
| `MaximumExternalPayloadCapacity` | `0` | Maximum vehicle weight, in pounds, that this vehicle can lift/tow with a chain or carry on configured racks. A value of `0` prevents chain-towing or rack-carrying other configured vehicles by default. |
