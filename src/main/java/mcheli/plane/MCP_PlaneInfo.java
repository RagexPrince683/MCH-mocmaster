...
public class MCP_PlaneInfo extends MCH_BaseVehicleInfo {
   ...
   public float pitchDamping = 0.410F;
   public float rollDamping = 0.405F;
   public float yawDamping = 0.475F;
   /** Scales resistance to angular acceleration without changing eventual control authority. */
   public float inertiaMultiplier = 1.550F;
   ...
   public float newFlightThrottleResponse = 1.18F;
   /** Pilot throttle increase/decrease rates used only by the new flight model. */
   public float newFlightThrottleChangeRateUp = 0.0055F;
   public float newFlightThrottleChangeRateDown = 0.0075F;
   /** Minimum effective engine power at zero commanded throttle. */
   public float newFlightIdleThrottle = 0.095F;
   /** Closed-throttle aerodynamic braking used by the new flight model. */
   public float newFlightEngineBrakeDrag = 0.0030F;
   ...
   public float criticalAoA = 14.00F;
   ...
   public float stallInstability = 0.560F;
   ...
   public float stallStrength = 1.080F;
   ...
   public float diveSpeedMultiplier = 1.28F;
   /** Load factor where high-G control authority begins to fade. */
   public float maxComfortableG = 7.5F;
   ...
   public float gControlPenalty = 0.680F;
