...
public class MCH_WeaponARM extends MCH_WeaponBase {

   public MCH_WeaponARM(World w, Vec3 v, float yaw, float pitch, String nm, MCH_WeaponInfo wi) {
   ...
   public boolean shot(MCH_WeaponParam prm) {
      ...
      if(prm.entity instanceof MCH_EntityAircraft) {
				...
				e = new MCH_EntityARM(this.worldObj, prm.posX, prm.posY, prm.posZ, tX, tY, tZ, yaw, pitch, this.acceleration);
				e.setName(this.name);    
