...
public class MCH_ClientCommonTickHandler extends W_TickHandler {
   ...
   private static void debugFlightControl(MCH_EntityBaseVehicle ac, float simDelta, float mouseX, float mouseY, float stickX, float stickY) {
      ...
      System.out.println(String.format(
              ...
              Boolean.valueOf(plane != null && plane.isLastTakeoffOnGround()),
              Boolean.valueOf(plane != null && plane.isLastTakeoffBlockProbeNearGround()),
              Boolean.valueOf(plane != null && plane.isLastTakeoffBoundingBoxNearGround()),
              Boolean.valueOf(plane != null && plane.isLastTakeoffNearRunwayGround()),
              plane != null ? plane.getLastTakeoffAssistBlockedReason() : "",
