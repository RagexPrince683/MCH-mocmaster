...
public class MCH_MOD {
  ...
  // /*     */   public static MCH_ItemSpawnGunner itemSpawnGunnerVsMonster;
   ...
   public void onStartServer(FMLServerStartingEvent event) {
      ...
      EntityRegistry.registerModEntity(MCH_EntitySeat.class, "MCH.E.Seat", 100, this, 800, 10, true);
      EntityRegistry.registerModEntity(MCH_EntityHeli.class, "MCH.E.Heli", 101, this, 800, 10, true);
      EntityRegistry.registerModEntity(MCH_EntityGLTD.class, "MCH.E.GLTD", 102, this, 200, 10, true);
      EntityRegistry.registerModEntity(MCP_EntityPlane.class, "MCH.E.Plane", 103, this, 800, 10, true);
      EntityRegistry.registerModEntity(MCH_EntityShip.class, "MCH.E.Ship", 401, this, 800, 10, true);
      ...
      EntityRegistry.registerModEntity(MCH_EntityVehicle.class, "MCH.E.Vehicle", 108, this, 800, 10, true);
      ...
      EntityRegistry.registerModEntity(MCH_EntityTank.class, "MCH.E.Tank", 112, this, 800, 10, true);
