...
public abstract class MCH_AircraftInfo extends MCH_BaseInfo {
   ...
   public MCH_AircraftInfo(String s) {
      ...
      this.stallLiftLoss = 0.65F;
      this.aoaDragMultiplier = 1.5F;
      this.stallInstability = 0.35F;
      this.stallRecoverySpeed = 0.0F;
