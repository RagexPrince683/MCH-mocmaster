...
public class MCH_EntityParticleExplodeLarge extends MCH_EntityParticleAnimated {

   private static final ResourceLocation texture = new ResourceLocation(W_MOD.DOMAIN, "textures/particles/explosion.png");//new ResourceLocation("textures/entity/explosion.png");

   public MCH_EntityParticleExplodeLarge(World w, double x, double y, double z, double size, double age, double mz) {
      super(w, x, y, z, size, 8, mz);
      super.numcol = 9;
      super.numrows = 9;
   }
