...
public class MCH_EntityParticleFlame extends MCH_EntityParticleBase {

   private static final ResourceLocation texture = new ResourceLocation(W_MOD.DOMAIN, "textures/particles/fire.png");//new ResourceLocation("textures/entity/explosion.png");
   int nowCount;
   ...
   public MCH_EntityParticleFlame(World w, double x, double y, double z, double size, double age, double mz) {
   ...
   public void renderParticle(Tessellator tessellator, float p_70539_2_, float p_70539_3_, float p_70539_4_, float p_70539_5_, float p_70539_6_, float p_70539_7_) {
      ...
      if(i <= 15) {
         ...
         float f6 = 0.1f*column;
         float f7 = 0.1f*(column+1);
         float f8 = (1/6) * row;
         float f9 = (1/6)*(row+1);
         double f10 = size * 3;
