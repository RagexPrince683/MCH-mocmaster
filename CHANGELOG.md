...
- Fixed plane A/D turning input while free look is active so left/right controls keep reaching the aircraft instead of being cleared by plane free-look handling.
